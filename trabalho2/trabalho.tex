...
Linux por trás (2, 3, 4) e além disso, também está por trás do Android que por
si só domina o mercado de celulares com mais 70\% (5, 6), fica fácil notar a
importância desse projeto para o mundo. O kernel Linux é famoso por ter uma única
pessoa que encabeça todo o projeto (Linus Torvalds), aceitando apenas o que
ele julga ser de excelência dos seus colaboradores (7, 8), esse simples fato
...
fork, criado pelo github, onde se cria uma cópia do projeto.

O Android é um dos maiores exemplos desse problema, por ser um projeto também open
source (9) as fabricantes de celulares criam versões próprias para seus aparelhos,
...
apenas 0,8\% utilizavam a versão mais recente (10).
...
dispositivos rodando a versão mais recente do IOS (11).
...
entre o sistema de janelas do sistema operacional e a computação gráfica (12),
...
gráfica do computador com as janelas do sistema chamado Picom (13), sofreu
...
software (17). Uma versão adicionou a capacidade de ter bordas redondas nas
janelas e o efeito de blur (14), outra melhorou o efeito de blur utilizando
um algorítmo mais performático (15) e por fim a terceira tenta juntar ambas
features mas não consegue se manter sempre atualizada (16) pois falta
...
\section{
    Por ter que atender muitos casos normalmente não
    atende bem um mercado específico
}
...
matéria (referência 2), podem ser consideradas “fábricas de apps”, que
...
para desenvolver o LogiOps (1). O grande problema identificado pelo Bruno
...
Diolinux (2). Existem diversos relatos de usuários que tiveram problemas com
...
interface alguma, onde precisa seguir passos via prompt de comando para poder corrigir (3). 
...
uma DebConf, (referência 1) dessa vez focando especificamente no empacotamento e
