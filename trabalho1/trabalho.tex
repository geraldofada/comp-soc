...
% ---
\title{Informática para usuários com deficiência \\ \small{Computação e Sociedade}}
\author{Bruno Mello\and Geraldo Fada\and Luciano Lage\and Rodrigo Correa}
\local{Brasil, Rio de Janeiro}
\date{13 de Julho 2021\\ \small{1° Semestre}}
...
De acordo com a Organização Mundial da Saúde, estima-se que mais de um bilhão
...
ou até mesmo para reabilitação cognitiva de distúrbios esquizofrênicos \cite{menezes2017aplicaccao}.
...
% ---
\chapter{Conclusão}
Torna-se evidente, portanto, por meio dos elementos aqui discorridos neste estudo,
que a acessibilidade à tecnologia para pessoas com deficiência, é um grande desafio
que se deve travar buscas de estudos e adaptações por nós enquanto sociedade.

Em um mundo cada vez mais conectado, a tecnologia e a informática fazem parte
do cotidiano de todas as pessoas, entretanto, como exposto nesse estudo, para
pessoas com deficiência, essa realidade muitas das vezes perpassa por diversas
dificuldades. 

Dessa maneira, cabe a área tecnológica voltar seu olhar a essa demanda cada vez
maior, afinal, há um número muito grande de deficientes e, de acordo com a
Organização Mundial da Saúde, estima-se para os próximos anos uma elevada
incidência de casos, gerando preocupação \cite{Disability}. Isso endossa ainda mais a
visão de um mundo mais inclusivo em todos os âmbitos, e a área da informática
se expressa ainda mais urgente à essa demanda.
